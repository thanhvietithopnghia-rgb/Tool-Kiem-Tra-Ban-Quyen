...
Catalog Microsoft này tách biệt với `software-license-catalog-v1.0.json` phiên bản `1.2.0.0`. Catalog phần mềm có 45 quy tắc sản phẩm; 16 quy tắc mang `Category` cho CAD/CAE/BIM, mô phỏng, kết cấu, GIS, EDA, đo lường và rendering. Các quy tắc đó bổ sung nhận diện signer/domain/tệp lõi/artifact nhưng không hạ ngưỡng kết luận fail-closed của engine quét sâu.
