...
> Tài liệu này là baseline lịch sử của v4.8 và được giữ để tham chiếu tương thích. Với v5.0, phiên bản, số lượng module/payload, catalog và metadata hiện hành phải lấy từ `RELEASE-MANIFEST.json` cùng tài liệu v5.0; các giá trị v4.8 bên dưới không mô tả build R6 hiện tại.
